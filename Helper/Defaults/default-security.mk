...
## gitleaks-scan
GITLEAKS_SCAN_TYPE ?= repo

## hawk-eye-scan
HAWK_EYE_SCAN_TYPE ?= fs
HAWK_EYE_SCAN_CONNECTION_PARAMETER ?= --connection connection.yml
HAWK_EYE_SCAN_JSON_OUTPUT_FILE ?= hawk-eye-scan-results.json
HAWK_EYE_SCAN_ADDITIONAL_PARAMETERS ?=
