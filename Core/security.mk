...
##
.PHONY: osv-container-scan
osv-container-scan:
	$(CONTAINER_COMMAND_BASE) $(CONTAINER_COMMAND_PARAMETER) $(CONTAINER_COMMAND_SERVICE) $(MAKE) _osv-container-scan

.PHONY: _osv-container-scan
_osv-container-scan:
